-- CreateEnum
CREATE TYPE "TaskOrder" AS ENUM ('CUSTOM', 'DUEDATE');

-- CreateEnum
CREATE TYPE "ProjectDisplay" AS ENUM ('LIST', 'BOARD');
...
CREATE TABLE "Project" (
    ...
    "name" TEXT NOT NULL,
    "color" TEXT,
    "display" "ProjectDisplay" NOT NULL DEFAULT 'LIST',
    "showCompleted" BOOLEAN NOT NULL DEFAULT false,
    "taskOrder" "TaskOrder" NOT NULL DEFAULT 'CUSTOM',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Project_inbox_key" ON "Project"("inbox");
...
-- AddForeignKey
ALTER TABLE "ProjectInvite" ADD CONSTRAINT "ProjectInvite_inviterId_fkey" FOREIGN KEY ("inviterId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
